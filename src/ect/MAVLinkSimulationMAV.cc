...
MAVLinkSimulationMAV::MAVLinkSimulationMAV(MAVLinkSimulationLink *parent, int systemid, double lat, double lon, int version) :
        ...
        firstWP(false),
        previousSPX(19.25),//(8.548056),
        previousSPY(-96.21),//(47.376389),
        previousSPZ(550),
        previousSPYaw(0.0),
        //nextSPX(8.548056),
        //nextSPY(47.376389),
...
void MAVLinkSimulationMAV::mainloop()
{
    ...
    if (timer1Hz <= 0)
    {
        ...
        mavlink_msg_heartbeat_pack_version_free(systemid, MAV_COMP_ID_IMU, &msg, MAV_FIXED_WING, MAV_AUTOPILOT_SLUGS, mavlink_version);//MAV_AUTOPILOT_PIXHAWK, mavlink_version);
